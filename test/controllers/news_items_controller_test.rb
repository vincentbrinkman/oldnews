...
class NewsItemsControllerTest < ActionController::TestCase
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post :create, news_item: { content: @news_item.content, sub_header: @news_item.sub_header, title: @news_item.title }
    end
  ...
  test "should update news_item" do
    patch :update, id: @news_item, news_item: { content: @news_item.content, sub_header: @news_item.sub_header, title: @news_item.title }
    assert_redirected_to news_item_path(assigns(:news_item))
  end
